            ...
            data[3] == 'A')
    {
        ...
        for (unsigned i = 0; i < nsegs; i++)
        {
            ...
            if (p.index == 3)
            {
                ...
                ind_airspeed = p.f[5] * knotsToMetersPerSecond*0.868976;
                true_airspeed = p.f[6] * knotsToMetersPerSecond*0.868976;
                groundspeed = p.f[7] * knotsToMetersPerSecond*0.868976;
